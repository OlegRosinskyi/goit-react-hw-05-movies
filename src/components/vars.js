...
//https://api.themoviedb.org/3/trending/get-trending?api_key=c861fc623ae12b9b041c6dade1c99e57
...
//export const DESKTOP_STUB = './src/images/no-Film-Img.jpg';
//export const TABLET_STUB = './src/images/no-Film-Img336x455.jpg';
//export const MOBILE_STUB = './src/images/no-Film-Img280x402.jpg';
...
export const SEARCH_MOVIE = 'search/search-movies';//'search/movie';поиск кинофильма по ключевому слову на странице фильмов.
export const GET_MOVIE_DETAILS = 'movies/get-movie-details'; //запрос полной информации о фильме для страницы кинофильма.
export const Get_MOVIE_CREDITS = 'movies/get-movie-credits'; //запрос информации о актёрском составе для страницы кинофильма.
export const Get_MOVIE_REWIEWS = 'movies/get-movie-reviews'; //запрос обзоров для страницы кинофильма.
